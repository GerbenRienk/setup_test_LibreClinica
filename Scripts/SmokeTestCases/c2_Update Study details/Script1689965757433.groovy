...
WebUI.setText(findTestObject('Object Repository/Page_OpenClinica/input_Protocol VerificationIRB Approval Dat_68d9db'), '01-Jan-2023')

WebUI.setText(findTestObject('Object Repository/Page_OpenClinica/input_Study Start Date_startDate'), '02-Jan-2023')

WebUI.setText(findTestObject('Object Repository/Page_OpenClinica/input_Study Completion Date_endDate'), '03-Jan-2023')

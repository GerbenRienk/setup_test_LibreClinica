...
WebUI.click(findTestObject('Object Repository/Page_LibreClinica/div_Actions_dynFilter'))

WebUI.setText(findTestObject('Object Repository/Page_LibreClinica/input_Actions_filter'), 'ST_ID001')

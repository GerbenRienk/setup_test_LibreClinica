...
def crc1 = GlobalVariable.st_crc1
WebUI.navigateToUrl(login_url)
WebUI.setText(findTestObject('Object Repository/input_User Name_j_username'), crc1)
WebUI.setEncryptedText(findTestObject('input_Password_j_password'), GlobalVariable.st_crc1_pw)
